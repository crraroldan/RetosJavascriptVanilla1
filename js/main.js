// Ejercicios JavaScript Vanilla.(I)
...
// if(nombre == "Fernando"){
//   console.log("Bienvenido Fernando");
// }else{
//   console.log("No eres Fernando, no te saludo");
// };
...
// let diaSemana = prompt("Dime un día de la semana").toLowerCase();
